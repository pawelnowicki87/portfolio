...
/* Sticky frosted nav with scroll-spy, language + theme toggles. */
export default function Nav({ t, active, language, setLanguage, darkMode, setDarkMode }) {
  ...
  return (
    <nav className={'nav' + (scrolled ? ' scrolled' : '')}>
      <a className="nav-brand" href="#top" onClick={(e) => { e.preventDefault(); scrollToId('top'); }}>
      ...
      <div className="nav-cta">
        ...
        <a className="icon-btn" href="https://github.com/pawelnowicki87" target="_blank" rel="noreferrer" aria-label="GitHub">
          <Icon name="github" size={18} />
        </a>
        <a className="icon-btn" href="https://www.linkedin.com/in/pawe%C5%82-nowicki-305380268/" target="_blank" rel="noreferrer" aria-label="LinkedIn">
